...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative hover:accent-foreground group/cover inline-block bg-background px-2 py-2  transition duration-200 rounded-sm"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
      ...
      <motion.span
        ...
        className={cn(
          "inline-block text-primary relative z-20 group-hover/cover:text-foreground transition duration-200",
          className
        )}
      >
        {children}
