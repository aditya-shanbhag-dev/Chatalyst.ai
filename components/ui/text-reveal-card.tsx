...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-background border border-border/[0.08] w-full rounded-lg p-8 relative overflow-hidden flex items-center justify-center",
        className
      )}
    >
      {children}
      ...
      <div className="h-40 relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-secondary z-20 will-change-transform"
        >
          <p
            style={{
